(function (root) {
    ...
    var dictionary = {
        en: {
            ...
            "card.sound": "Sound",
            "card.soundOn": "Sound on",
            "card.soundOff": "Tap for sound",
            "watch.back": "← Back to wall",
            "watch.loading": "Loading…",
            "watch.openKick": "Watch on Kick",
            "watch.none": "No channel selected.",
            "watch.copy": "Copy link",
            "watch.copied": "Link copied",
            "card.scanning": "Scanning the roster…",
            "empty.streamers": "The roster is being redrawn. Return shortly.",
            "streamers.search": "Search channels…",
            "streamers.sortLive": "Live first",
            "streamers.sortAZ": "A–Z",
            "streamers.liveOnly": "Live only",
            "streamers.noMatch": "No channels match your search.",
            "streamers.offline": "You're offline — live status is unavailable.",
            ...
            "book.openHint": "Click the cover to open",
            ...
            "history.sub": "Press Save in the top bar to store a restore point. The last 3 of each are kept.",
            "history.save": "Save",
            "history.saved": "Saved a restore point.",
            "history.saveFail": "Couldn't save the version.",
            "admin.saveHint": "Unsaved changes — press Save to keep them.",
            "history.streamers": "Streamers",
            "history.book": "Book",
            "history.restore": "Restore",
            "history.restored": "Restored.",
            "history.confirmRestore": "Restore this saved version? It replaces the current one.",
            ...
            "msg.loginForPublish": "Log in again to enable live publishing.",
            "pdf.replace": "Replace PDF",
            "pdf.remove": "Remove PDF",
            "pdf.attached": "PDF attached",
            "pdf.uploading": "Uploading to the server…",
            "pdf.uploaded": "PDF uploaded and confirmed ✓",
            "pdf.uploadFail": "PDF upload failed.",
            "pdf.removed": "PDF removed.",
            "pdf.notPdf": "Please choose a PDF file.",
            "pdf.tooLarge": "PDF is too large ({mb} MB). Maximum is {max} MB.",
            "pdf.reading": "Reading the file…",
            "pdf.verifying": "Confirming the upload…",
            "pdf.tooLargeServer": "The server rejected the file — please use a smaller or compressed PDF.",
            "book.pdfLoading": "Loading PDF…",
            "book.pdfMissing": "PDF not available.",
            "book.pdfOpen": "Open full PDF",
        ...
        ar: {
            ...
            "card.watching": "مشاهد",
            "card.sound": "الصوت",
            "card.soundOn": "الصوت يعمل",
            "card.soundOff": "اضغط للصوت",
            "watch.back": "← العودة للقائمة",
            "watch.loading": "جارٍ التحميل…",
            "watch.openKick": "شاهد على Kick",
            "watch.none": "لم تُحدَّد قناة.",
            "watch.copy": "نسخ الرابط",
            "watch.copied": "تم نسخ الرابط",
            "card.scanning": "جارٍ فحص القائمة…",
            "empty.streamers": "يُعاد رسم القائمة، عُد بعد قليل.",
            "streamers.search": "ابحث عن قناة…",
            "streamers.sortLive": "المباشر أولاً",
            "streamers.sortAZ": "أ–ي",
            "streamers.liveOnly": "المباشر فقط",
            "streamers.noMatch": "ما فيه قنوات تطابق بحثك.",
            "streamers.offline": "أنت غير متصل — حالة البث غير متاحة.",
            ...
            "book.openHint": "اضغط الغلاف لِلفتح",
            ...
            "admin.backHome": "← الرئيسية",
            "admin.lock": "قفل",
            "history.title": "النسخ المحفوظة",
            "history.sub": "اضغط «حفظ» في الشريط العلوي لتخزين نقطة رجوع. تُحفظ آخر 3 نسخ من كلٍّ.",
            "history.save": "حفظ",
            "history.saved": "تم حفظ نقطة رجوع.",
            "history.saveFail": "تعذّر حفظ النسخة.",
            "admin.saveHint": "لديك تعديلات غير محفوظة — اضغط «حفظ» لحفظها.",
            "history.streamers": "الستريمرز",
            "history.book": "الكتاب",
            "history.restore": "استرجاع",
            "history.restored": "تم الاسترجاع.",
            "history.confirmRestore": "استرجاع هذه النسخة؟ ستحلّ محلّ الحالية.",
            "history.empty": "لا توجد نسخ محفوظة بعد.",
            ...
            "msg.loginForPublish": "سجّل الدخول مجدداً لتفعيل النشر المباشر.",
            "pdf.replace": "استبدال PDF",
            "pdf.remove": "إزالة",
            "pdf.attached": "ملف PDF مرفق",
            "pdf.uploading": "جارٍ الرفع إلى الخادم…",
            "pdf.uploaded": "تمّ رفع الملف وتأكيده ✓",
            "pdf.uploadFail": "فشل رفع الـPDF.",
            "pdf.removed": "تمت إزالة الـPDF.",
            "pdf.notPdf": "اختر ملف PDF.",
            "pdf.tooLarge": "حجم الملف كبير جداً ({mb} م.ب). الحدّ الأقصى {max} م.ب.",
            "pdf.reading": "جارٍ قراءة الملف…",
            "pdf.verifying": "جارٍ تأكيد الرفع…",
            "pdf.tooLargeServer": "رفض الخادم الملف — استخدم PDF أصغر أو مضغوطاً.",
            "book.pdfLoading": "جارٍ تحميل الـPDF…",
            "book.pdfMissing": "الـPDF غير متاح.",
            "book.pdfOpen": "افتح الـPDF كاملًا",
            "book.goto": "اذهب إلى صفحة",
